...
class  CreateEventController extends AppController
{
    ...
    private function extractCreateEventRequest(Request $request): CreateEventRequest
    {
        ...
        return new CreateEventRequest(
            ...
            isGuestOnly: $params->get('create-event-guest-check')->asBool(),
            participantsLimit: $params->getOrThrow('create-event-participants-number')->asInt(),
            startAt: $startAt,
            endAt: $endAt,
            location: $params->getOrThrow('create-event-location-field')->asString(),
            locationDetails: $params->get('create-event-compAddress-text')->asString(''),
            placeId: '',
            address: '',
