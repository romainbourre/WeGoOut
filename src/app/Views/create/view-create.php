                        ...
                        <div class="collapsible-body">
                            ...
                            <div class="row"> <!-- CATEGORY OF EVENT -->
                                ...
                                <div class="input-field col s12">
                                    ...
                                    <select class="validate" name="create-event-category-select" id="create-event-category-select">
                                        <option selected disabled>Sélèctionner une catégorie</option>
                                        <?php use App\Librairies\AppSettings;

                                        foreach ($eventCategories as $category): ?>
                                            <option value="<?= $category[0] ?>"><?= $category[1] ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                    <div id="create-event-category-feedback" class="feedback form-control-feedback"></div>
                                </div>
