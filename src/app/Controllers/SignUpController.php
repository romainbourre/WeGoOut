...
namespace App\Controllers
{
    ...
    class SignUpController extends AppController
    {
        ...
        /**
         * Displaying registration web page
         */
        ...
        public function signUp(Request $request): Response
        {
            try
            {
                ...
                list($registration_first_name,
                    ...
                    $registration_sex) = $cleaned_data;

                $birthDate = (new DateTime())->setTimestamp($registration_birth_date);
                $signUpRequest = new SignUpRequest($registration_first_name, $registration_last_name, $registration_email,
                                                   $birthDate, $registration_location_label, $registration_location_postal_code,
                                                   $registration_location_city, $registration_location_country, $registration_location_longitude,
                                                   $registration_location_latitude, $registration_location_place_id, $registration_password, $registration_sex);
        ...
        public function getData(Request $request): ?array
        {
            ...
            )
            {
                ...
                )
                {
                    ...
                    $registration_location_postal_code = htmlspecialchars($params['registration-user-postalCode-hidden']);
                    ...
                    $registration_location_longitude = (float)htmlspecialchars($params['registration-user-longitude-hidden']);
                    $registration_location_latitude = (float)htmlspecialchars($params['registration-user-latitude-hidden']);
                    ...
                    // CHECK BIRTH DATE
                    if (preg_match('#^([0-9]{2})([/-])([0-9]{2})\2([0-9]{4})$#', $registration_birth_date, $d) && checkdate($d[3], $d[1], $d[4]))
                    {
